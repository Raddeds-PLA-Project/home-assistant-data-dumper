...
def db_root(subpath, app_db: ApplicationDatabaseManager):
    ...
    if db_subpath == "info":
        ...
        if not db_unlocked:
            ...
            newest_entry_time = app_db.entity_db.time_of_newest_entry()
            oldest_entry_time = app_db.entity_db.time_of_oldest_entry()
            return {
                "is_unlocked": db_unlocked,
                ...
                "entry_count": app_db.entity_db.get_entry_count()
            }
